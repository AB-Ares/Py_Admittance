...
.. note::
    In order to access these example files, it will be necessary to download or clone the entire Py_Admittance repo from `GitHub <https://github.com/AB-Ares/Py_Admittance>`_. The files will be located in the directory `examples`. 

`Broquet & Wieczorek (2019) <https://agupubs.onlinelibrary.wiley.com/doi/abs/10.1029/2019JE005959>`_ admittance model
------------------------------------------------------------------------------------------------------------------------------------
